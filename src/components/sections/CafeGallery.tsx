...
const PhotoCard = ({
  ...
  const accentRgb =
    photo.accent === "#00f0ff" ? "0,240,255" : "191,97,255";
    ...
    >
      ...
      >
        ...
        <motion.h2
          ...
          className="text-white font-black text-[38px] xs:text-[48px] sm:text-[56px] md:text-[68px] leading-[1.1] mb-3"
        >
          The Arena,{" "}
          <span
            style={{
        ...
        <motion.div
          ...
          style={{
            ...
            margin: "0 auto",
            background:
              "linear-gradient(90deg,transparent,#bf61ff 40%,#00f0ff 60%,transparent)",
            transformOrigin: "left",
          }}
        />
      </div>
